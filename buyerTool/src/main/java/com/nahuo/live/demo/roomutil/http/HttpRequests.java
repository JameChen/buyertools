package com.nahuo.live.demo.roomutil.http;
...
public class HttpRequests {
    ...
    public void login(long sdkAppID, String accountType, String userID, String userSig, final OnResponseCallback<HttpResponse.LoginResponse> callback) {
        try {
            String body = "";
            String url = domain.concat("/login").
                    concat(String.format("?sdkAppID=%s&accountType=%s&userID=%s&userSig=%s",
                            String.valueOf(sdkAppID), accountType, userID, userSig));
