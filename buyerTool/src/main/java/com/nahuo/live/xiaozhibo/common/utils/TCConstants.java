...
public class TCConstants {
    public static final String MESSAGETYPE_LIVEWATCHCOUNT="livewatchcount";
    public static final String MESSAGETYPE_LIVESETTRYGOODS="livesettrygoods";
    //小直播相关配置请参考:https://www.qcloud.com/document/product/454/7999
    //************在腾讯云开通各项服务后，将您的配置替换到如下的几个定义中************
    public static final String SECRET_ID="AKIDZ7xYu04Us15yd6SQHuIdw2uXyB9snv86";
    public static final String SECRET_KEY="rXzC90g6k9JFwOlxue8NQFoKgnfIhrmS";
    public static final String API_VERSION="2018-08-01";
    public static final String API_REGION="ap-guangzhou";
    public static final String appKey="9cbc6a093e1751b9d6e247cd114c2754";
    public static final long sdkAppID=1400203963;
    public static final String appID="1259066511";
    public static final String accountType="36862";
    public static final String DomainName="47474.livepush.myqcloud.com";
    ...
    public static final String TENCENT_CLOUD_API = "https://live.tencentcloudapi.com";
    public static final String FCGI_VIDEO_QCLOUD="http://fcgi.video.qcloud.com/common_access";
    //Room service的地址
    ...
    public static final int CODE_TX_KILL_OUT        = 6208;
    ...
    public static final String PLAY_CHANG_ID       = "play_chang_id";
