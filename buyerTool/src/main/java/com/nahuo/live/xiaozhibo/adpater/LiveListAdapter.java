...
import static com.nahuo.buyertool.common.Constant.TYPE_LEVEL_0;
import static com.nahuo.buyertool.common.Constant.TYPE_LEVEL_1;
        ...
        switch (helper.getItemViewType()) {
            ...
            case TYPE_LEVEL_1:
                ...
                if (item != null) {
                    ...
                    GlideUtls.loadRoundedCorners(context, R.drawable.empty_photo, ImageUrlExtends.getImageUrl(sub.getCover()), big_iv);
                    GlideUtls.loadRoundedCorners(context, R.drawable.empty_photo, ImageUrlExtends.getImageUrl(cover01), iv_01);
                    GlideUtls.loadRoundedCorners(context, R.drawable.empty_photo, ImageUrlExtends.getImageUrl(cover02), iv_02);
                    GlideUtls.loadRoundedCorners(context, R.drawable.empty_photo, ImageUrlExtends.getImageUrl(cover03), iv_03);
