package com.nahuo.live.xiaozhibo.videoeditor.word.widget;
...
public class CustomProgressBar extends AbsProgressBar {
    ...
    private void init(AttributeSet attrs) {
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.progressBar_c);
        startFillColor = a.getColor(R.styleable.progressBar_c_startFillColor, 0xffff0000);
        middleFillColor = a.getColor(R.styleable.progressBar_c_middleFillColor, 0xffff0000);
        endFillColor = a.getColor(R.styleable.progressBar_c_endFillColor, 0xffff0000);
        arrowPointColor = a.getColor(R.styleable.progressBar_c_arrowPointColor, 0xffffffff);
        a.recycle();
    }
