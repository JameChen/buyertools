package com.nahuo.live.xiaozhibo.push.screen;
...
import com.nahuo.live.xiaozhibo.push.screen.widget.FloatingCameraView;
import com.nahuo.live.xiaozhibo.push.screen.widget.FloatingView;
...
public class TCScreenRecordActivity extends TCLiveBasePublisherActivity {
    ...
    protected void startPublishImpl() {
        ...
        mLiveRoom.setPauseImage(BitmapFactory.decodeResource(getResources(), R.mipmap.recording_background_private_vertical));
        mLiveRoom.setScreenRecordAutoEnable(true);
...
//        }
    ...
    public void requestDrawOverLays() {
        if (Build.VERSION.SDK_INT > 24 && !Settings.canDrawOverlays(TCScreenRecordActivity.this)) {
