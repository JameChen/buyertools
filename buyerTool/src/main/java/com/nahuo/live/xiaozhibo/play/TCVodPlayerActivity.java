...
import com.nahuo.buyertool.dialog.VodplayerRateMenu;
...
//                        });
    ...
    private void gotoPlay(int AgentItemID) {
        floatingVideoService = IntentUtls.getPlayIntent(Vthis, mPlayUrl,changShiID,playProgress);
        startService(floatingVideoService);
        Intent intent = new Intent(Vthis, ShopDetailsActivity.class);
        intent.putExtra(ShopDetailsActivity.EXTRA_ID, AgentItemID);
        intent.putExtra(ShopDetailsActivity.EXTRA_NAME, "");
