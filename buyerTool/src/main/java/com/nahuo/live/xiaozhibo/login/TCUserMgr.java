package com.nahuo.live.xiaozhibo.login;
...
import static com.nahuo.live.xiaozhibo.common.utils.TCConstants.CODE_TX_KILL_OUT;
...
public class TCUserMgr {
    ...
    private long mSdkAppID = TCConstants.sdkAppID;
    private String mUserSig = "";
    private String mAccountType = TCConstants.accountType;
...
//    public void autoLogin(Context context, final Callback callback) {
//        loginByToken(context, mUserId, mUserPwd, callback);
//    }
//
...
//    private void loginByToken(Context context, final String userid, final String pwd, final Callback callback) {
//        try {
////            String priKeyContent = "-----BEGIN PRIVATE KEY-----\r\n" + "MIGHAgEAMBMGByqGSM49AgEGCCqGSM49AwEHBG0wawIBAQQg9LKFBONLsxn8MXBm\r\n" + "5qt71wv3p+/N/6nLjgvJDYGHS3GhRANCAAQYzUplfXS0kinKJHdK7o5DluL4ncoK\r\n" + "sfFPnztf78nGYKRjIfqkextCXcddTRHa4EuDgQHhgvaPmHH7xZ1tmrKp\r\n" + "-----END PRIVATE KEY-----\r\n";
//////            tls_sigature.GenTLSSignatureResult result = tls_sigature.GenTLSSignatureEx(TCConstants.sdkAppID, userid, priKeyContent, 24 * 3600 * 180);
//////            System.out.println(result.urlSig);
////            WebRTCSigApi api = new WebRTCSigApi();
////            api.setSdkAppid((int) TCConstants.sdkAppID);
////            api.setPrivateKey(priKeyContent);
////            String userSig = api.genUserSig(userid, 2000 * 50);
////            mSdkAppID = TCConstants.sdkAppID;
////            mAccountType = TCConstants.accountType;
////            mUserId = userid;
//            mSdkAppID=TCConstants.sdkAppID;
//            mAccountType=TCConstants.accountType;
//            mUserId=SpManager.getIdentifier(BWApplication.getInstance());
//            mUserSig=SpManager.getUserSig(BWApplication.getInstance());
//            mNickName= SpManager.getUserName(BWApplication.getInstance());
//            mUserAvatar=SpManager.getShopLogo(BWApplication.getInstance());
//            // mUserSig=result.urlSig;
//            initRoom(context);
//            fetchUserInfo(null);
//            saveUserInfo();
//            if (callback != null) {
...
//            }
////            TIMManager.getInstance().login(userid, result.urlSig, new TIMCallBack() {
////                @Override
...
//    }
    ...
    public void loginTxLive(Context context, final String userid, final String pwd) {
        mSdkAppID = TCConstants.sdkAppID;
        mAccountType = TCConstants.accountType;
        mUserId = userid;
        mUserSig = pwd;
...
//            }
    ...
    private void initRoom(final Context context) {
        try {
            ...
            loginInfo.accType = mAccountType;
...
//            initInfo.sign = "70188085e4adfa721dec309b3800e809";
            LiveRoom liveRoom = TCLiveRoomMgr.getLiveRoom();
            liveRoom.login(TCConstants.ROOM_SVR_URL, loginInfo, new LiveRoom.LoginCallback() {
                @Override
                public void onError(int errCode, String errInfo) {
                    if (errCode == CODE_TX_KILL_OUT) {
                ...
                @Override
                public void onSuccess(String userupload_ugcId) {
