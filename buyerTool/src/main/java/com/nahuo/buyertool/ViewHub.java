...
//
    ...
    public static void setEditError(EditText et, String error) {
        et.setError(Html.fromHtml("<font color='red'>" + error + "</font>"));
        et.requestFocus();
    }
    ...
    public  interface EditDialogListener {
         ...
         void onOkClick(DialogInterface dialog, EditText editText);
     ...
     * @author JorsonWong
     */
    public static void showOKLightPopDialogNoDismiss(Activity activity, CharSequence title, CharSequence messgae
            , CharSequence positive, boolean isShow,PopDialogListener positiveListener) {
        try {
            final LightPopDialog dialog = new LightPopDialog(activity);
            dialog.setIsShowDismiss(isShow);
            dialog.setFocusable(false);
            dialog.setTitle(title).setMessage(messgae).setPositive(positive, positiveListener)
                    .show();
            dialog.getmRootView().setOnTouchListener(null);
        } catch (BadTokenException e) {
            e.printStackTrace();
            CrashReport.postCatchedException(new CatchedException(e));
        }
