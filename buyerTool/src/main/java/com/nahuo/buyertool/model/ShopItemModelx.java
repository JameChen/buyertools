 ...
 * 微铺款式实体类
 */
public class ShopItemModelx implements Serializable {
...
//totalSalecount
    ...
    @Expose String DescriptionHead;//商品描述
    @Expose String DescriptionFoot;
    ...
    public String getMiniUrl() {
        return "pages/pinhuo/itemdetail?id=" + String.valueOf(ItemID);
    }
    ...
    private String uploadStatus = "等待";//上传状态
...
//        }
    ...
    public String getTuanPiItemUrl() {
        return "http://item.weipushop.com/wap/qsitem/" + ItemID;
    }
