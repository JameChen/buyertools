...
import com.nahuo.buyertool.adapter.ColorSelectAdapter;
...
public class ColorPicsSelectDialog extends Dialog implements View.OnClickListener, ColorSelectAdapter.Listener {
    static ColorPicsSelectDialog dialog = null;
    private Activity mActivity;
    View mRootView;
    TextView btn_ok, btn_cancle;
    int h, w;
    PopDialogListener mPopDialogListener;
    List<UploadBean.ColorPicsBean> list;
    ...
    public ColorPicsSelectDialog setIs_upload(boolean is_upload) {
        this.is_upload = is_upload;
        return this;
    }

    public ColorPicsSelectDialog setUrl(String url) {
        this.url = url;
        return this;
    }

    public ColorPicsSelectDialog(@NonNull Activity context) {
    ...
    public static ColorPicsSelectDialog getInstance(Activity activity) {
        if (dialog == null) {
            dialog = new ColorPicsSelectDialog(activity);
        }
        return dialog;
    }

    public ColorPicsSelectDialog setList(List<UploadBean.ColorPicsBean> list) {
        this.list = list;
        return this;
    }

    public ColorPicsSelectDialog setID(int parentID, int subID) {
        this.parentID = parentID;
        this.subID = subID;
        return this;
    }

    public ColorPicsSelectDialog setType(int type) {
        this.type = type;
        return this;
    }
    ...
    private void initViews() {
        ...
        adapter = new ColorSelectAdapter(mActivity);
        adapter.setType(CategoryAdapter.TYPE_PARENT);
        adapter.setListener(this);
        FullyGridLayoutManager manager = new FullyGridLayoutManager(mActivity, 5, GridLayoutManager.VERTICAL, false);
...
//            }
            ...
            adapter.setUrl(url);
            adapter.setIs_upload(is_upload);
...
//                }
            ...
            case R.id.tv_ok:
                String color="bai";
                if (adapter != null) {
                    color= adapter.setParentValue();
                }
                if (mPopDialogListener != null) {
                    mPopDialogListener.onColorPicsDialogButtonClick(color);
                }
//                if (loopView != null)
//                    choose_index = loopView.getSelectedItem();
//                if (subLoopView != null)
...
//                }
    ...
    public ColorPicsSelectDialog setPositive(PopDialogListener listener) {
...
//    }
    ...
    @Override
    public void onPareItemClick(int mpos) {
...
//        }
    ...
    public interface PopDialogListener {
        void onColorPicsDialogButtonClick(String color);
    }
}
