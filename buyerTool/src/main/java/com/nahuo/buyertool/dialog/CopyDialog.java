...
public class CopyDialog extends Dialog implements View.OnClickListener {
    ...
    public CopyDialog(@NonNull Activity context) {
        super(context, R.style.popDialog);
        this.mActivity = context;
    }

    public static CopyDialog getInstance(Activity activity) {
        if (dialog == null) {
            dialog = new CopyDialog(activity);
        }
        return dialog;
    }

    public CopyDialog setList(MyStyleBean bean) {
        this.bean = bean;
        return this;
    }
...
//        }
    ...
    public CopyDialog setPositive(PopDialogListener listener) {
        mPopDialogListener = listener;
        return this;
    }

    public interface PopDialogListener {
        void onCopyDialogButtonClick( MyStyleBean bean, String oldStr ,String newStr);
    }
}
