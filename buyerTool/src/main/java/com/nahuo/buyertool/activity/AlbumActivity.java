...
import com.nahuo.buyertool.adapter.AlbumGridViewAdapter;
import com.nahuo.buyertool.adapter.ImgDirListAdapter;
import com.nahuo.buyertool.model.ImageDirModel;
...
public class AlbumActivity extends BaseActivity {
    ...
    private void init() {
        ...
        imgDirAdapter.setOnItemClickListener(new ImgDirListAdapter.OnImgDirClickListener() {
            @Override
            ...
            public void onItemClick(final ToggleButton toggleButton, int position, final String path, boolean isChecked) {
                ...
                if (isChecked) {
                    if (!hashMap.containsKey(path)) {
                        ...
                        imageViewModel.setUploadStatus(ImageViewModel.UploadStatus.NONE.NONE);
