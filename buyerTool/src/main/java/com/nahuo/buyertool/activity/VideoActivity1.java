...
import com.nahuo.buyertool.customview.MyJCVideoPlayerStandard;
import com.nahuo.buyertool.customview.RoundProgressBarWidthNumber;
...
public class VideoActivity1 extends AppCompatActivity implements View.OnClickListener {
    ...
    public static final String PINHUP_ROOT_DIRECTORY = "/buyertool/buyertool_video_save";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        jcVideoPlayerStandard.setUp(url
                , JCVideoPlayerStandard.SCREEN_WINDOW_FULLSCREEN, "买手工具");
