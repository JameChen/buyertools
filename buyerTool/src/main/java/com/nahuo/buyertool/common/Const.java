...
public class Const {
    //上传图片刷新间隔
    public static final int UPLOAD_IMG_INTERVAL=20;
    public static final int UPLOAD_VIEDEO_INTERVAL=20;
    public static final String IMAGES_CASH_PATH="booyertool/booyertool_image_save";
    public static final String VIDEOS_CASH_PATH="/booyertool/booyertool_video_save/";
    public static final String IMAGES_CROP_CASH_PATH="booyertool/booyertool_image_save/crop";
    public static final String         LOGIN_PRE_KEY            = "LOGIN_PRE_KEY";
    public static final String         LOGIN_PRE_LIST_KEY            = "LOGIN_PRE_LIST_KEY";
...
//        已复制的商品=6
    ...
    public static class Bugly{
        public static final String APP_ID = "900013540";
        public static final String APP_KEY = "JdMYQYkho8nXVRJr";
    }
    /**
     * @description 商品地址
...
//        public static final String SUPPLIERS_SEND_GOOD    = "供货商发货";
    ...
    public static class UploadStatus {
        ...
        /** 等待上传 */
        public static final String UPLOAD_WAIT   = "待上传";
        /** 上传失败 */
        public static final String UPLOAD_FAILED = "失败";
        /** 上传我擦*/
        public static final String UPLOAD_FINISH= "完成";
        /** 无网络 */
