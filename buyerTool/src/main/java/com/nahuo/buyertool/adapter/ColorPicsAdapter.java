...
public class ColorPicsAdapter extends
        RecyclerView.Adapter<ColorPicsAdapter.ViewHolder>implements ItemTouchHelperAdapter {
    public static final int TYPE_CAMERA = 1;
    public static final int TYPE_PICTURE = 2;
    private LayoutInflater mInflater;
    private List<UploadBean.ColorPicsBean> list = new ArrayList<>();
...
//        }
   ...
   //当拖拽选中时放大选中的view
    ...
    public ColorPicsAdapter(Context context, onAddPicClickListener mOnAddPicClickListener) {
    ...
    public void setList(List<UploadBean.ColorPicsBean> list) {
        this.list = list;
    }
    public List<UploadBean.ColorPicsBean>  getList() {
        return list;
    }
...
//    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = mInflater.inflate(R.layout.color_gv_filter_image,
                viewGroup, false);
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        //少于8张，显示继续添加的图标
          final UploadBean.ColorPicsBean media= list.get(position);
        String path = "";
        if (media.is_upload()){
            ...
            viewHolder.mImg.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                     int adapterPosition = viewHolder.getAdapterPosition();
                        mOnAddPicClickListener.onAddPicClick(adapterPosition,v);
                }
            });
        }else {
