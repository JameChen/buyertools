...
import com.nahuo.buyertool.model.ShopInfoResultModel;
...
public class BuyOnlineAPI {
     ...
     */
    public ShopItemModelx getPiHuoItemDetailNew(int id, int qid, String cookie) throws Exception {
        ShopItemModelx result = null;
        try {
            ...
            result = GsonHelper.jsonToObject(json, ShopItemModelx.class);
...
//            Log.i(TAG, "tctc：getItemDetail::::" +   tc.end());
    ...
    *//**
     ...
     * @author ZZB
     *//*
    public static void addFavorite(Context context, long itemId) throws Exception {
        Map<String, String> params = new HashMap<String, String>();
    ...
    */
     ...
     * @param pageSize  每页显示的数据条数
     */
    public ShopItemListResultModel getshopitems(String keyword, int pageIndex, int pageSize, String userid,
                                                 String cookie) throws Exception {
       // List<ShopItemListModelX> nahuoItemList = null;
        ShopItemListResultModel shopItemListResultModel;
        try {
            Map<String, String> params = new HashMap<String, String>();
            ...
            params.put("type", "list");
            params.put("sort", "1");
            params.put("timeBucket", "1");
            params.put("incApplying", "true");
            params.put("createDateDescSort", "1");
            params.put("fromType", "1");
            params.put("topDescSort", "0");
            params.put("showShopInfo", "true");
            params.put("getTotal", "true");
            String json = HttpUtils.httpPost("shop/agent/GetShopItems2", params, cookie);
            Log.i(TAG, "Json：" + json);

            // 解析数据
            shopItemListResultModel = GsonHelper.jsonToObject(json,
                    new TypeToken<ShopItemListResultModel>() {
                    });
            //nahuoItemList = shopItemListResultModel.getDatas();
        ...
        return shopItemListResultModel;
    }
     ...
     * @param pageSize  每页显示的数据条数
     */
    public StyleBean getMyStyleShopitems(String keyword, int pageIndex, int pageSize, String statuid, String isHide,
                                         String cookie) throws Exception {
        StyleBean bean = null;
        try {
            Map<String, String> params = new HashMap<String, String>();
            ...
            params.put("PageIndex", String.valueOf(pageIndex));
            params.put("PageSize", String.valueOf(pageSize));
            params.put("statuid", statuid);
            params.put("typeid", isHide);
            params.put("keyword", keyword);
            params.put("ver","2");
          //  String json = HttpUtils.httpPost("shop/GetMyItems4PinHuo", params, cookie);
            String json = HttpUtils.httpPost("shop/GetMyItems4PinHuoV2", params, cookie);
            Log.i(TAG, "Json：" + json);

            // 解析数据
            bean = GsonHelper.jsonToObject(json,
                    new TypeToken<StyleBean>() {
                    });
     ...
     * 批量上架
     */
    public void batchShelves(String ids, String shopCats, String rate, String cookie) {
        Map<String, String> params = new HashMap<String, String>();
        params.put("ids", ids);
        params.put("shopCats", shopCats);
        params.put("rate", rate);
        params.put("isClone", "true");
        try {
            String json = HttpUtils.httpPost("shop/agent/ImportItemBatch", params, cookie);
            Log.i(TAG, "Json：" + json);
        } catch (Exception e) {
            e.printStackTrace();
        }
     ...
     * 批量克隆
     */
    public void batchClone(String ids, String cookie,String oldStr,String newStr) throws Exception{
        Map<String, String> params = new HashMap<String, String>();
        params.put("ids", ids);
        params.put("oldStr", oldStr);
        params.put("newStr", newStr);
            String json = HttpUtils.httpPost("shop/agent/CopyItemBatch", params, cookie);
            Log.i(TAG, "Json：" + json);
     ...
     * @author Chiva Liang
     */
    public List<ShopItemListModelX> getshopitems(Context context, Params.GetShopItems params) throws Exception {
        List<ShopItemListModelX> nahuoItemList = null;
        try {
     ...
     * @author peng jun
     * *//*
    public List<String> getHotUsers(Context context) throws Exception {
        try {
            Map<String, String> paramsMap = new HashMap<String, String>();

            paramsMap.put("fromType", "1");
            String cookie = PublicData.getCookie(context);
            String json = HttpUtils.httpGet(RequestMethod.SearchMethod.GET_HOT_SHOPS, paramsMap, cookie);

            // 解析数据
            List<String> datas = GsonHelper.jsonToObject(json,
            ...
            if (datas != null && datas.size() > 0) {
                ...
                SpManager.setString(context, SearchPresenter.PREF_KEY_HOT_SHOPS, builder.toString());
            }
return datas;
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    */
    ...
    public static int shareToWP(Context context, Share2WPItem item) throws Exception {
        ...
        try {
            ...
            params.put("waitDays", item.getWaitDays());
            params.put("groupDealCount", item.getGroupDealCount());
            ...
            String json = HttpUtils.httpPost("shop/ImportItem4PinHuo", params, cookie);
    ...
    *//**
    ...
    public ShopItemModel getItemDetail(int id, String cookie) throws Exception {
        ...
        try {
            Map<String, String> params = new HashMap<String, String>();
            params.put("id", String.valueOf(id));
            String json = HttpUtils.httpPost("shop/agent/getitemdetail", params, cookie);
            Log.i(TAG, "Json：" + json);
