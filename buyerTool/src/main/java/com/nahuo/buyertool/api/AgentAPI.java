...
import com.nahuo.buyertool.model.Agent;
import com.nahuo.buyertool.model.AgentGroup;
import com.nahuo.buyertool.model.ApplyItem;
...
//        result = "{'Datas': [{'UserID': 129766,'UserName' : 'xxxxxxxx','Statu': '申请','CreateDate': '2014-07-10 11:34:33','Message': '就是要申请，不加不行' }]}";
     ...
     * @throws Exception
     */
    public static boolean addGroupUsers(Context context, int groupId, String userIds) throws Exception {
        String cookie = PublicData.getCookie(context);
        Map<String, String> params = new HashMap<String, String>();
