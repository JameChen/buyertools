...
public class HttpUtils {
    ...
    private static final String BASE_URL = IS_LOCAL ? "http://api2.nahuo.com/" : "http://api2.nahuo.com/";
    ...
    public static String LoginPost(String method, Map<String, String> params) throws Exception {
        String result = LoginPost("", method, params, false, "");
        return result;
    }
...
//            http://api2.nahuo.com/v3/buyertool/buyer/UpdateItemScheduleInfo
//            http://api2.nahuo.com/v3//buyertool/buyer/UpdateItemScheduleInfo?{days=0, qsid=15306, agentItemId=952264}
            if (isJson == true) {
                // Json格式作为参数
            ...
            if (statusCode == 200) {
                ...
                if ("shop/agent/order/CheckOrderIsPaid".equals(method)) {// 检测订单支付状态原数据返回，因为要判断各种状态
                    return strContent;
                }
     ...
     * @param cookie cookie值
     */
    private static String LoginPost(String website, String method, Map<String, String> params, boolean isJson,
                                   String cookie) throws Exception {
        try {
            // API服务地址
            String url = "";
...
//            http://api2.nahuo.com/v3//buyertool/buyer/UpdateItemScheduleInfo?{days=0, qsid=15306, agentItemId=952264}
            ...
            if (statusCode == 200) {
                ...
                ResultData resultData = GsonHelper.jsonToObject(strContent, ResultData.class);
                            ...
                            if (headers != null && headers.length > 0) {
                                for (Header header : headers) {
                                    ...
                                    if (header.toString().contains(nhStrPrefix)) {
                                        ...
                                        // 保存cookie
                                        String cookie1 = cookieFulllStr.substring(cookieFulllStr.indexOf(nhStrPrefix),
                                                cookieFulllStr.length());
                                        PublicData.setCookieOnlyAtInit(cookie1);
                                        break;
                                    }
                                }
                            }
