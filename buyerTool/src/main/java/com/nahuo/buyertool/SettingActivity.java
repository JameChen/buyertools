...
import com.nahuo.buyertool.common.Const.PasswordExtra;
import com.nahuo.buyertool.common.Const.PasswordType;
import com.nahuo.buyertool.common.FileUtils;
import com.nahuo.buyertool.common.VersionUtils;
import com.nahuo.buyertool.controls.WidgetSettingItem;
...
public class SettingActivity extends BaseActivity2 implements OnClickListener {
    ...
    private class ClearTask extends AsyncTask<Object, Void, String> {
        ...
        protected String doInBackground(Object... params) {
            ...
            gcCountEnd += getFileSize(cacheFile, 0);
            //清除sd cache
            File cacheFile1 = new File(SDCardHelper.getSDCardRootDirectory()+"/buyertool/qrcode_cache");
            File cacheFile2 = new File(SDCardHelper.getSDCardRootDirectory()+"/buyertool/share");
            File cacheFile3 = new File(SDCardHelper.getSDCardRootDirectory()+"/buyertool/share_download");
            File cacheFile4 = new File(SDCardHelper.getSDCardRootDirectory()+"/buyertool/tackPhoto_tmp");
            File cacheFile5 = new File(SDCardHelper.getSDCardRootDirectory()+"/buyertool/upload_tmp");
