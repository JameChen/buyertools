 ...
 */
public class BuyerWaveAntiAliased_Shader extends View {
	...
	public BuyerWaveAntiAliased_Shader(Context context) {
		this(context, null);
	}

	public BuyerWaveAntiAliased_Shader(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public BuyerWaveAntiAliased_Shader(Context context, AttributeSet attrs, int defStyleAttr) {
