 ...
 *
 */
public class BuyerWaveAntiAliased extends View {
	...
	public BuyerWaveAntiAliased(Context context) {
		this(context, null);
	}

	public BuyerWaveAntiAliased(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public BuyerWaveAntiAliased(Context context, AttributeSet attrs, int defStyleAttr) {
