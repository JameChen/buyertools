...
public class TimeUtils {
    ...
    public static final String DEFAULT_DATEDAY_FORMAT = "yyyy-MM-dd";
     ...
     * @author PJ
     */
    public static String getDefaultTimeStampDate(){
        return millisToTimestamp(System.currentTimeMillis(), DEFAULT_DATEDAY_FORMAT);
    }
    /**
     * @description 获取当天默认格式的日期字符串
