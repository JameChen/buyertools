...
public class MainMenuFragment extends BaseEditFragment implements View.OnClickListener {
    ...
    private View mMosaicBtn;//马赛克按钮
    private View mEnhanceBtn;//图片增强
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mMosaicBtn = mainView.findViewById(R.id.btn_mosaic);
        mEnhanceBtn=mainView.findViewById(R.id.btn_enhance);
        ...
        mEnhanceBtn.setOnClickListener(this);
    }
