...
public class RotateFragment extends BaseEditFragment  {
    ...
    private TextView rotate_value,rotate_btn_along,rotate_btn_inverse,rotate_btn_reset;//角度值
    private int du=0;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        rotate_value=(TextView) mainView.findViewById(R.id.rotate_value);
        rotate_btn_along=(TextView) mainView.findViewById(R.id.rotate_btn_along);
        rotate_btn_inverse=(TextView) mainView.findViewById(R.id.rotate_btn_inverse);
        rotate_btn_reset=(TextView) mainView.findViewById(R.id.rotate_btn_reset);
        rotate_btn_along.setOnClickListener(new MenuClick(1));
        rotate_btn_inverse.setOnClickListener(new MenuClick(2));
        rotate_btn_reset.setOnClickListener(new MenuClick(3));
