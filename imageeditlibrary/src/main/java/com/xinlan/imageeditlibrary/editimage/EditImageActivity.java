...
public class EditImageActivity extends BaseActivity {
    ...
    public static final String EXTRA_PICS_LIST = "EXTRA_PICS_LIST";
    ...
    public static final int MODE_MOSAIC = 8;//马赛克模式
    public static final int MODE_ENHANCE = 9;//图片增强模式
    ...
    public DrawMosaicView mDrawMosaicView;//马赛克
    ...
    public MosaicFragment mMosaicFragment;//马赛克
    public EnhanceFragment mEnhanceFragment;//增强
     ...
     * @param requestCode
     */
    public static void start(Activity context, final String editImagePath, final String outputPath, final ArrayList<String> picList, final int requestCode) {
        ...
        it.putStringArrayListExtra(EditImageActivity.EXTRA_PICS_LIST, picList);
    ...
    private void getData() {
        ...
        picList = getIntent().getStringArrayListExtra(EditImageActivity.EXTRA_PICS_LIST);
        Bundle bundle = new Bundle();
        bundle.putStringArrayList(EXTRA_PICS_LIST, picList);
        mAddTextFragment.setArguments(bundle);
        loadImage(filePath);
    }
    ...
    private void initView() {
        ...
        mDrawMosaicView = (DrawMosaicView) findViewById(R.id.mosaic_panel);
        ...
        public void onClick(View v) {
            switch (mode) {
                ...
                case MODE_BEAUTY://保存美颜后的图片
                    ...
                    break;
                case MODE_MOSAIC://保存马赛克
                    mMosaicFragment.savePaintImage();
                    break;
                case MODE_ENHANCE:
                    mEnhanceFragment.savePaintImage();
                    break;
                default:
                    break;
            }// end switch
